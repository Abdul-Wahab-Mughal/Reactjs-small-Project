    ...
    <>
      ...
      >
        <img
          ...
          alt="img"
        />
        <p className="absolute bottom-14 duration-500 opacity-0 line-clamp-5 pl-4 pr-1 w-full sm:text-lg text-white z-10 font-bold group-[.active]:animate-[upRoof_0.25s_forwards_0.5s]">
          {text}
        </p>
        <div className="bg-gradient-to-b from-[#10111040] to-[#101110] absolute w-full h-full top-0"></div>
        <div className="h-[10px] sm:h-[20px] duration-500 absolute bottom-5 left-2 group-[.active]:h-[25px] group-[.active]:sm:h-[30px] group-[.active]:left-3 px-1">
